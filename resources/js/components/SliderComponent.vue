<template>
    ...
    <div class="bg-red-600 py-5">
        ...
        <div class="container mx-auto px-2">
            <div class="relative max-w-5xl mb-8 mx-auto">
            ...
            <div class="overflow-hidden max-w-5xl mx-auto aspect-video rounded-xl relative">
                ...
                <div v-else ref="carousel" class="flex transition-transform ease-in-out duration-[800ms] rounded-3xl"
                    ...
                    <a target="_blank" class="carouselDiv w-5xl" v-for="(image, index) in imagesArr" :key="index"
                        :href="image.link"
                        :style="{ backgroundImage: `url(${image.url})`, width: `${100 / imagesArr.length}%` }"
                        :title="image.name"></a>
                </div>
            </div>
